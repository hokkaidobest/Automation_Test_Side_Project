...
def test_search_product_with_keyword(driver):
    keyword = "洋裝"
...
def test_search_product_with_empty_keyword(driver):
    keyword = ""
    main_page = MainPage(driver)
...
def test_search_product_with_keyword_but_empty_result(driver):
    keyword = "Hello"
    main_page = MainPage(driver)
